...
NAME_DISPLAY.prototype.refresh = function()
{
	...
	if ($mm_updatedMapName !== "") {
		text = $mm_updatedMapName;
	}
	else if (checkMapNote("mm_areaname:")) {
		text = getMapNote("mm_areaname:");
	}
	else {
	...
	while (
		this.textWidth(text) > RES_W * MAP_W - _minimapNamePadding * 2 &&
	...
	this.contents.drawText(
		...
		RES_X,
		RES_Y,
		RES_W * MAP_W - _minimapNamePadding,
		this.lineHeight(),
		"center"
	);
};
