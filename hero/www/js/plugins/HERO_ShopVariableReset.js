...
(function() {
    ...
    function generateShop(callback) {
        ...
        function rollNext() {
            ...
            runGachaCommonEvent(function(success) {
                ...
                /*
                 * If the gacha didn't produce a valid result, just roll
                 * again.
                 */
                if (!category || !id) {
    ...
    Game_Interpreter.prototype.openHeroShop = function() {
        ...
        /*
         * Prevent accidentally starting two generators from the same
         * interpreter.
         */
